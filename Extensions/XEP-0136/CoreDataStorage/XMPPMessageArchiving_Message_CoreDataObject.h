...
typedef NS_ENUM(int16_t, XMPPMessageArchiving_Message_CoreDataObjectMessageType) {
    ...
    XMPPMessageArchiving_Message_CoreDataObjectMessageTypeRoomCreated       = 4,
    XMPPMessageArchiving_Message_CoreDataObjectMessageTypeRoomDestroyed     = 5,
    
    XMPPMessageArchiving_Message_CoreDataObjectMessageTypeAttachment        = 6,
...
@property (strong, nonatomic) NSString *documentFolderAndFileName;  // Attachment folder and file name (e.g. 'folder/file.txt')
@property (strong, nonatomic) NSString *documentURL;                // Attachment's download URL
